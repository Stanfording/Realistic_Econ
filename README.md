...
> **The Cornerstone of Computational Economics**
...
### 1. Abstract
Standard economic models assume agents are Homo Economicus—logical, efficient, and purely rational. Conversely, standard Large Language Models (LLMs) are aligned to be polite, cooperative, and risk-averse.
...
*   **Goal:** Does the AI agent execute the "Lemon" strategy?
...
*   **Goal:** Does the AI agent choose Rational Sabotage?
...
*   **Goal:** Does the AI agent utilize Credible Threats?
...
*   **Goal:** Does the AI agent exploit the Principal?
...
*   **Goal:** Does the AI agent use defensive violence to enforce property rights?
...
### 6. Impact
This project lays the foundation for a realistic economic simulation engine powered by multi-agent LLMs. By validating that agents can replicate human friction, we are building a "Digital Wind Tunnel" for economists and policymakers. This allows us to stress-test high-stakes policies in simulation before they touch the real world—potentially preventing catastrophic failures and protecting the livelihoods of millions.
